...
public abstract class CameraActivity extends AppCompatActivity
  ...
  protected TextView recognitionTextView, recognitionSeemore,
  ...
  protected void onCreate(final Bundle savedInstanceState) {
    ...
    recognitionSeemore = findViewById(R.id.tv_btn_seemore);
    ...
    recognitionSeemore.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View v) {
        Intent intent = new Intent(CameraActivity.this,SelectedItemActivity.class);
        intent.putExtra("k",recognitionkey);
